            ...
            <div class="card-body justify-center items-center navbar-bg">
                ...
                <form onSubmit={handleSubmit(onSubmit)} class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 bg-card p-4">
                    ...
                    <div >
                        ...
                        <input name='price' placeholder='Price' {...register("price")} className="input input-bordered w-full max-w-xs" type="number" />
                        ...
                        <button
                            className='btn btn-accent w-full max-w-xs text-white mx-auto ' type="submit">Add Product</button>
                    </div>
                </form>
